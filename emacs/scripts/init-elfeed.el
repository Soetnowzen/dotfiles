...
(use-package elfeed
  ...
  (setq elfeed-feeds '(("http://www.mmo-champion.com/external.php?do=rss&type=newcontent&sectionid=1&days=120&count=10" news)
                       ...
                       ("http://darklegacycomics.com/feed.xml" comics)
                       ))
