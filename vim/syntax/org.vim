...
let g:org_todo_keywords = ['TODO', 'ON HOLD', 'WAITING', 'CANCELED', '|', 'DONE', 'DELEGATED']
let g:org_todo_keywords_faces = [['ON HOLD', 'yellow'], ['WAITING', 'yellow'], ['CANCELED', 'red'], ['DONE', 'green'], ['DELEGATED', 'green']]
